...
services:
  ...
  api:
    ...
    environment:
      ...
      MUSEARR_API_PORT: 5540
      MUSEARR_WEB_ORIGIN: "http://${MUSEARR_HOST:-localhost}:${MUSEARR_PORT:-5530}"
...
MUSEARR_PORT=5530
MUSEARR_WEB_ORIGIN=http://localhost:5530
...
MUSEARR_API_URL=http://localhost:5540
